/**
 * Meditation Content Data
 * Fixed: Backtick escaping and string termination
 */
const meditationData = {
  // English Section (Currently empty)
  en: {
    "Palm-Sunday": { title: "Palm Sunday", scripture: "", text: "" },
    Monday: { title: "Monday", scripture: "", text: "" },
    Tuesday: { title: "Tuesday", scripture: "", text: "" },
    Wednesday: { title: "Wednesday", scripture: "", text: "" },
    Thursday: { title: "Thursday", scripture: "", text: "" },
    "Good-Friday": { title: "Good Friday", scripture: "", text: "" },
    Saturday: { title: "Saturday", scripture: "", text: "" },
    "Easter-Sunday": { title: "Easter Sunday", scripture: "", text: "" },
  },

  // Korean Section
  ko: {
    "Palm-Sunday": {
      title: "종려주일 (Palm Sunday)",
...
[마태복음 21:18-21]
18) 이른 아침에 성으로 들어오실 때에 시장하신지라 19) 길 가에서 한 무화과나무를 보시고 그리로 가사 잎사귀 밖에 아무 것도 찾지 못하시고 나무에게 이르시되 이제부터 영원토록 네가 열매를 맺지 못하리라 하시니 무화과나무가 곧 마른지라 20) 제자들이 보고 이상히 여겨 이르되 무화과나무가 어찌하여 곧 말랐나이까 21) 예수께서 대답하여 이르시되 내가 진실로 너희에게 이르노니 만일 너희가 믿음이 있고 의심하지 아니하면 이 무화과나무에게 된 이런 일만 할 뿐 아니라 이 산더러 들려 바다에 던져지라 하여도 될 것이요`,
    },
    Tuesday: {
      title: "화요일 (Tuesday)",
...
[마가복음 14:12-25]
12) 무교절의 첫날 곧 유월절 양 잡는 날에 제자들이 예수께 여짜오되 우리가 어디로 가서 선생님께서 유월절 음식을 잡수시게 준비하기를 원하시나이까 하매 13) 예수께서 제자 중의 둘을 보내시며 이르시되 성내로 들어가라... (생략)`,
    },
    "Good-Friday": {
      title: "성금요일 (Good Friday)",
      scripture: "마태복음 26:47-49, 27:27-31, 누가복음 23:44-47",
      text: `[마태복음 26:47-49]
47) 말씀하실 때에 열둘 중의 하나인 유다가 왔는데 대제사장들과 백성의 장로들에게서 파송된 큰 무리가 칼과 몽치를 가지고 그와 함께 하였더라 48) 예수를 파는 자가 그들에게 군호를 짜 이르되 내가 입맞추는 자가 그이니 그를 잡으라 한지라 49) 곧 예수께 나아와 랍비여 안녕하시옵니까 하고 입을 맞추니
...
[누가복음 23:44-47]
44) 때가 제육시쯤 되어 해가 빛을 잃고 온 땅에 어둠이 임하여 제구시까지 계속하며 45) 성소의 휘장이 한가운데가 찢어지더라 46) 예수께서 큰 소리로 불러 이르시되 아버지 내 영혼을 아버지 손에 부탁하나이다 하고 이 말씀을 하신 후 숨지시니라 47) 백부장이 그 된 일을 보고 하나님께 영광을 돌려 이르되 이 사람은 정녕 의인이었도다 하고`,
    },
    Saturday: {
      title: "토요일 (Saturday)",
